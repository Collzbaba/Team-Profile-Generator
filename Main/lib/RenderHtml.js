...
return renderMain(html.join("\index.html"), html.join("\index.html "));
    };

const renderManager = manager =>{
    let templates = fs.readFileSync(path.resolve(templatesDir, "manager.html"), "utf8");
    ...
    templates = replacePlaceholders(templates, "officeNumber", manager.getoffice());
    return templates;
};
